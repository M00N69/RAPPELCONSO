...
def load_data(url, start_date=START_DATE):
    ...
    base_url_with_date_filter = f"{url}&refine.date_publication:>={urllib.parse.quote(start_date_str)}&refine.date_publication:<={urllib.parse.quote(today_str)}&rows={API_PAGE_SIZE}"
